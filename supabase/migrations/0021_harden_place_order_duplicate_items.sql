-- Phase 4 follow-up: optimized place_order replacement.
--
-- This file keeps migration version 0021 present for environments that already
-- reached the old duplicate-item hardening step. Fresh databases can still apply
-- it safely; it is idempotent and leaves place_order at the optimized definition.
--
-- Atomic, idempotent customer order placement.
--
